...
public class ChiTietHoaDon_GUI extends JFrame {
    ...
    private void xuLyThanhToan() {
        try {
            ...
            java.util.Date today = new java.util.Date(); // Lấy ngày giờ hiện tại
            java.sql.Date ngayLapSql = new java.sql.Date(today.getTime());

            HoaDon hd = new HoaDon(maHD, nv.getMaNV(), maKH, null, maBan, ngayLapSql);
